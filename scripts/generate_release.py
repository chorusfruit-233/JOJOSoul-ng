...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate release content from RELEASE.md')
    parser.add_argument('--version', '-v', required=True, 
                       help='Version to generate content for (e.g., 2.0.0)')
    parser.add_argument('--output', '-o', default='release_body.md',
                       help='Output file path (default: release_body.md)')
    parser.add_argument('--release-file', default='RELEASE.md',
